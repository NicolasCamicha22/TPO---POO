 ...
 * @author lucho
 */
public class vtnPeticionesResultado extends javax.swing.JFrame {

    /**
     * Creates new form vtnPracticasResultado
     */
    public vtnPeticionesResultado() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Resultados de Practicas"));

        btnPeticiones.setText("Nueva Peticion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnPeticionesResultado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vtnPeticionesResultado().setVisible(true);
            }
        });
    }
