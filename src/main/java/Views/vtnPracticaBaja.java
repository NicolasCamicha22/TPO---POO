 ...
 * @author lucho
 */
public class vtnPracticaBaja extends javax.swing.JFrame {

    /**
     * Creates new form vtnPracticaBorrar
     */
    public vtnPracticaBaja() {
        initComponents();
    }
    ...
    private void btnConfirmarBajaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarBajaActionPerformed
        // TODO add your handling code here:
         if (txtCodigo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(txtCodigo, "Complete el campo Codigo de practica");
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vtnPracticaBaja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vtnPracticaBaja().setVisible(true);
            }
        });
    }
